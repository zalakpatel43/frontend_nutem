...
@Component({
  selector: 'app-downtime-tracking-list',
...
export class DowntimeTrackingListComponent implements OnInit {
  ...
  constructor(
    private downtimeTrackingService: DowntimeTrackingService,
  ...
  removeDowntimeTracking(id: number) {
    const result = confirm(`Are you sure you want to delete this Downtime Tracking record?`);
    if (result) {
