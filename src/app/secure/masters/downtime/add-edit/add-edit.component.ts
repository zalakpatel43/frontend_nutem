...
downtimeTrackingDetailsList: any;
  ...
  transformData(originalData) {
    ...
    const result = {
      ...
      ProductionOrderId: this.isEditMode ? this.downtimeTrackingData.ProductionOrderId : originalData.ProductionOrderId,
      FillingLineId: this.isEditMode? this.downtimeTrackingData.FillingLineId: originalData.FillingLineId,
